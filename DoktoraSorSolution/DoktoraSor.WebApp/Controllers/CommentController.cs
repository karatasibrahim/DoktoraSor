...
namespace DoktoraSor.WebApp.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        public ActionResult ShowNoteComments(int? id)
        {
            ...
            Note note =noteManager.ListIQueryable().Include("Comments").FirstOrDefault(x=>x.Id==id);
            if (note==null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create(Comment comment, int? noteid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    comment.DoctorOwner = CurrentSession.UserDoctor;
                }
                comment.PatientOwner = CurrentSession.UserPatient;
